...
- this is your own Mubu bridge / agent CLI project
- you are also contributing the harness upstream to CLI-Anything
- upstream contribution does not erase your authorship of your own repository

Do not use this framing:

- "CLI-Anything is my project"
- "I own the CLI-Anything Mubu integration officially"
- "This is the official CLI-Anything release" unless the upstream maintainers say that explicitly

## Current Status

As of 2026-03-18:

- upstream PR: `HKUDS/CLI-Anything#99`
- PR URL: `https://github.com/HKUDS/CLI-Anything/pull/99`
- independent repo: `https://github.com/cnfjlhj/cli-anything-mubu`

If the PR is merged later, update the wording from "submitted upstream" to "merged upstream".
...
Avoid these because they overstate ownership or status:

- "I built CLI-Anything."
- "This is the official CLI-Anything Mubu product."
- "CLI-Anything's Mubu module belongs to me."
- "The upstream project is maintained by me." unless that becomes formally true
